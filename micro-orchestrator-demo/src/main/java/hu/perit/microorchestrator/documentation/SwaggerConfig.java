...
package hu.perit.microorchestrator.documentation;
...
public class SwaggerConfig
{
    ...
    public OpenAPI openApi()
    {
        return new OpenAPI()
                .info(new Info()
                        .title("micro-orchestrator-demo")
                        .description("micro-orchestrator-demo")
                        .version("1.0")
                        .license(new License()
                        ...
                        .contact(new Contact()
                                .name("Peter Nagy")
                                .url("https://github.com/nagypet/microorchestrator")
