...
@EnableJpaRepositories(basePackages = DbConfig.PACKAGES,
        entityManagerFactoryRef = DbConfig.ENTITY_MANAGER_FACTORY,
...
public class DbConfig
{
    ...
    public static final String PERSISTENCE_UNIT = "micro-orchestrator-db";
    private static final String DATASOURCE = "dataSource";

    private final ConnectionParam connectionParam;

    public DbConfig(DatasourceCollectionProperties dbProperties)
    {
